...
package net.sourceforge.marvinproject.statistical.median;
 ...
 */
public class Median extends MarvinAbstractPluginImage {
		...
		for (int x = 0; x < width; x++) {
			for (int y = 0; y < height; y++) {
				if(l_arrMask != null && !l_arrMask[x][y]){
					...
					a_imageOut.setRGB(x, y, l_totalRed / qtd, l_totalGreen / qtd, l_totalBlue / qtd);
