...
package net.sourceforge.marvinproject.combine.alphaBlending;
	...
	)
	{
		...
		for (int y = 0; y < maxH; y++) {
			for (int x = 0; x < maxW; x++) {
				...
				l_g1 = 255;
				l_b1 = 255;
				image3.setRGB(x, y, l_r1, l_g1, l_b1);
				//Prints a_image
				...
				if (y < image2.getHeight() && x < image2.getWidth()) {
					...
					if((x+xi)<maxW&&(y+yi)<maxH)
						image3.setRGB(x+xi, y+yi, l_r1, l_g1, l_b1);
				}
				}
			}
		}
		...
		//Set image3
		MarvinImage.copyRGBArray(image3, a_imageOut);
		}
	}
