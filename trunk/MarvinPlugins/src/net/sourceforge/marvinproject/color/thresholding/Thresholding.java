...
package net.sourceforge.marvinproject.color.thresholding;
 ...
 */
public class Thresholding extends MarvinAbstractPluginImage{

	private MarvinAttributes attributes;
	private int threshold;
	private MarvinPluginImage pluginGray;
	
	public void load(){
		
		attributes = getAttributes();
		attributes.set("threshold", 125);
		pluginGray = MarvinPluginLoader.loadPluginImage("net.sourceforge.marvinproject.color.grayScale.jar");
	}
